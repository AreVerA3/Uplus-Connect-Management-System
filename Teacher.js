...
function uploadStudentData() {
    ...
    const school_level = document.getElementById('school_level').value; // Corrected 'id'
    const subjects = document.getElementById('subjects').value; // Corrected 'id'
    const grade = document.getElementById('grade').value;
    const attendance = document.getElementById('attendance').value;

    if (student_name && school_level && subjects && grade && attendance) {
        const formData = new FormData();
        formData.append('student_name', student_name); // Ensure key matches PHP script
        ...
        fetch('upload_student_data.php', {
            ...
            .then(data => {
                ...
                document.getElementById('school_level').value = '';
